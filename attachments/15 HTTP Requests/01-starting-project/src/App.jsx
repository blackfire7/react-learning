    ...
    return (
        <>
            ...
            <Modal open={errorUpdatingPlaces} onClose={handleError}>
                {errorUpdatingPlaces && <ErrorMessage title='An error occurred!' message={errorUpdatingPlaces.message}
            ...
            <main>
                {error && <ErrorMessage title="An error occurred!" message={error.message}></ErrorMessage>}
